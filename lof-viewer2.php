...
function lof_viewer2_shortcode() {
    ...
    <div id="lof-viewer-v2-root" class="lof-viewer-shell lof-viewer lof-state--loading">
        ...
        <section id="lof-speaker-card" class="lof-speaker-card" style="display:none;">
            <div class="lof-card-header">
                <h3 id="speaker-title">🔊 Need Sound?</h3>
            </div>
            <div class="lof-card-body">
                <div id="speaker-status" class="speaker-status"></div>
                <div id="speaker-message" class="speaker-message"></div>
                <div class="speaker-countdown" id="speaker-countdown" style="display:none;">
                    ⏱️ <span id="countdown-value">5:00</span> remaining
                </div>
                <button id="speaker-proximity-confirm-btn" class="lof-btn lof-btn--primary" style="display:none;">
                    ✓ Yes, I'm at the show
                </button>
                <button id="speaker-primary-btn" class="lof-btn lof-btn--primary" disabled>Turn On Speakers</button>
                <div class="speaker-alternatives">
                    <button id="fm-info-btn" class="lof-btn-text">📻 FM <span id="fm-freq">107.7</span></button>
                    <button id="stream-btn" class="lof-btn-text">🌐 Audio Stream</button>
                </div>
                <div id="speaker-hint" class="speaker-hint" style="display:none;"></div>
            </div>
        </section>
    ...
    <div id="stream-mini-player" class="lof-stream-player" style="display:none;">
        <div class="lof-stream-header">
            ...
            <div class="lof-stream-controls">
                <button id="stream-minimize-btn" class="lof-stream-btn">−</button>
                <button id="stream-close-btn" class="lof-stream-btn">×</button>
            </div>
        </div>
        <div id="stream-content" class="lof-stream-content">
            <p>Ready to start the perfectly synced audio?</p>
            <button id="stream-start-btn" class="lof-btn lof-btn--primary">▶ Start Audio</button>
        </div>
        <div id="stream-container" class="lof-stream-iframe-container" style="display:none;"></div>
    </div>
    <?php
    return ob_get_clean();
}
